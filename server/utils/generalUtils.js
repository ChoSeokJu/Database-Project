...
exports.nowDate = function (x) {
    ...
    if (x == 'Date') {
        ...
        let formattedTime = unformattedTime.replace(/ (AM)|(PM)/i, '').replace(' ', '');
...
exports.finalScore = function (x) {
    const {
        SubmitCnt, TotalTupleCnt, DuplicatedTupleCnt, NullRatio,
    } = x;
...
exports.permitState = (n) => {
    ...
    if (n == 'pending') { return '승인대기'; }
    if (n == 'rejected') { return '신청거절'; }
    if (n == null) { return '미신청'; }
};
